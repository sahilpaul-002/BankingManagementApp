  ...
  return (
    <div className="w-full h-screen bg-[var(--nav-bg)] flex items-center justify-center relative overflow-hidden">
      ...
      <div className="applicationLoader-container w-full h-full relative z-10 animate-fade-in">
        {/* <h1
          // className="text-[140px] md:text-[180px] font-medium italic text-[var(--gold)] opacity-90 absolute top-1/2 left-1/2 -translat-x-1/2 -translate-y-1/2"
          className="text-[64px] font-medium italic text-[var(--gold)] opacity-90 absolute top-1/2 left-1/2 -translate-x-3/5 -translate-y-3/4"
