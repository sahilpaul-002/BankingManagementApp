...
export type errorStatusTypes = "BAD_REQUEST" | "UNAUTHENTICATED" | "UNAUTHORIZED" | "FORBIDDEN" | "NOT_FOUND" | "INVALID_SESSION" | "INTERNAL_SERVER_ERROR" | "INVALID_HEADER" | "INVALID_REQUEST_BODY_PARAMETER"  | "INVALID_REQUEST_QUERY_PARAMETER" | "ERROR" | "FAILED" | "SERVICE_UNAVAILABLE" | "SERVICE_TIMEOUT"
