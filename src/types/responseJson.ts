...
export type errorStatusTypes = "BAD_REQUEST" | "UNAUTHENTICATED" | "UNAUTHORIZED" | "FORBIDDEN" | "NOT_FOUND" | "INVALID_SESSION" | "INTERNAL_SERVER_ERROR" | "INVALID_HEADER" | "INVALID_REQUEST_BODY_PARAMETER"  | "INVALID_REQUEST_QUERY_PARAMETER" | "SERVICE_ERROR" | "SERVICE_UNAVAILABLE" | "SERVICE_TIMEOUT" | "EXTERNAL_SERVICE_ERROR";
